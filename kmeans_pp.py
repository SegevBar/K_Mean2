...
mergedDataPoints = fileOneDataPoints.merge(fileTwoDataPoints, how='inner', on='c0')
...
finalCentroids = np.array(mykmeanssp.fit(k, maxIterations, dataPointsSize, centroidsLoc, dataPoints1D))
